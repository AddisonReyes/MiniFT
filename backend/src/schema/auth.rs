...
#[schema(example = json!({
    ...
    "currency": "USD",
    "turnstile_token": "0._turnstile_token"
}))]
pub struct RegisterRequest {
    ...
    /// Cloudflare Turnstile token generated by the registration form.
    #[serde(default)]
    #[schema(write_only, example = "0._turnstile_token")]
...
pub struct LoginRequest {
    ...
    #[schema(min_length = 8, write_only, example = "StrongPass123")]
    pub password: String,
    /// Cloudflare Turnstile token generated by the login form.
    #[serde(default)]
    #[schema(write_only, example = "0._turnstile_token")]
    pub turnstile_token: String,
}
